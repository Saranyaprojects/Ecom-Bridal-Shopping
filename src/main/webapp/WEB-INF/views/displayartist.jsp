...
body {
	background: url(resources/images/back_img3.jpg) !important;
	padding: 100px;
	height: 100%;
}
</style>
					 ...
					 <div id="f1_container1">
						<div id="f1_card1" class="shadow">
							<div class="front face">
								<!-- <img class="alb" src="D:\my Bridal Shopping\Bridal shopping\Frontnd\src\main\webapp\WEB-INF\resources\images.12345.jpg">
				</div>   -->
