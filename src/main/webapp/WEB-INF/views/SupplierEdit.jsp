...
<br> <br> <br>
<br> <br> <br>
<form class="form-horizontal" action="supplierEdit" method="post" onsubmit="return formCategory()" >
  <div class="form-group">
    <label class="control-label col-sm-offset-2 col-sm-3" for="email">Supplier ID:</label>
    <div class="col-sm-3">
